...
def main():
    ...
    contact_book = FileHandler.load_from_file('contacts.json')

    while True:
        action = input("Введите 'add' для добавления контакта, 'list' для просмотра контактов, 'exit' для выхода: ")
    ...
    FileHandler.save_to_file(contact_book, 'contacts.json')
